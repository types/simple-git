...
declare namespace simpleGit {
  ...
  export class Git {
     ...
     */
    addAnnotatedTag(tagName: string, tagMessage: string, handlerFn: HandlerFunction): Git;
     ...
     */
    checkoutBranch(branchName: string, startPoint: any, handlerFn: HandlerFunction): Git;
     ...
     */
    diffSummary(options: any, handlerFn: (error: any, summary: DiffSummary) => void): Git;
     ...
     */
    mergeFromTo(from: string, to: string, options?: any, handlerFn?: HandlerFunction): Git;

    /**
     * Clone and mirror the repo to local
     */
    mirror(repoPath: string, localPath: string, handlerFn: HandlerFunction): Git;
     ...
     */
    pull(remote: string, branch: string, options: any, handlerFn: HandlerFunction): Git;
